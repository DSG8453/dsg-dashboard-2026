...
// DSG Transport Chrome Extension IDs (policy + unpacked dev)
const DSG_EXTENSION_IDS = [
  'ecplabhnjcnjbpfggkgmjifakboclhlo', // Policy-installed ID
  'hommlifemnoidmlmgmciledgnbpamgep', // Legacy/unpacked ID
];
...
export const ToolCard = ({ tool, onDelete, onUpdate }) => {
  ...
  const handleExtensionAccess = async () => {
    ...
    if (!extensionId && typeof chrome !== 'undefined' && chrome.runtime) {
      for (const knownId of DSG_EXTENSION_IDS) {
        try {
